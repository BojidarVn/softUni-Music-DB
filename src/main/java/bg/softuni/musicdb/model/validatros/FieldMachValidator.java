package bg.softuni.musicdb.model.validatros;
...
public class FieldMachValidator implements ConstraintValidator<FieldMach, Object> {
    ...
    @Override
    public void initialize(FieldMach constraintAnnotation) {
